...
public class CameraRaycasterEditor : Editor
{
    ...
    void PrintString()
    {
        string currentString = serializedObject.FindProperty("strToPrint").stringValue;
        string newString = EditorGUILayout.TextField("StringToPrint", currentString);
        if (currentString != newString)
        {
            serializedObject.FindProperty("strToPrint").stringValue = newString;
        }
    }
    void BindArraySize()
    {
